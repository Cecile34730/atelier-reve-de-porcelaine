...
export default function Home() {
  return (
    ...
    <tbody>
    <tr className="border-b bg-green-50"><td className="p-3 font-semibold">Mardi</td><td className="p-3">Adultes</td><td className="p-3">19h - 21h</td></tr>
    <tr className="border-b"><td className="p-3 font-semibold" rowSpan={2}>Mercredi</td><td className="p-3">Enfants 5-7 ans</td><td className="p-3">10h30 - 12h</td></tr>
    <tr className="border-b bg-green-50"><td className="p-3">Enfants 8 ans +</td><td className="p-3">15h30 - 17h</td></tr>
    <tr className="border-b"><td className="p-3 font-semibold" rowSpan={2}>Jeudi</td><td className="p-3">Adultes</td><td className="p-3">14h - 16h</td></tr>
    <tr className="border-b bg-green-50"><td className="p-3">Adultes</td><td className="p-3">19h - 21h</td></tr>
    <tr><td className="p-3 font-semibold">Samedi</td><td className="p-3">Adultes</td><td className="p-3">10h - 12h</td></tr>
    </tbody>
    </table>
    </div>
    </div>
